...
class SadadException
{
    ...
    private static $results = array(
        array(
            'code' => SadadException::ERROR_CONNECT,
            'message' => SadadException::ERROR_CONNECT_MESSAGE,
            'fa' => 'خطا در اتصال به درگاه سداد',
            'en' => 'Error in connect to sadad',
            'retry' => false
        ),
        array(
            'code' => SadadException::INVALID_RESPONSE_CODE,
            'message' => SadadException::INVALID_RESPONSE_MESSAGE,
            'fa' => 'جواب نامعتبر',
            'en' => 'Invalid Response',
            'retry' => false
        ),
    ...
    public static function getMessage($code, $message)
    {
        $result = SadadException::codeResponse($code, $message);
        if ($result) {
            return $result;
        }
        $result = array(
            'code' => SadadException::UNKNOWN_CODE,
            'message' => SadadException::UNKNOWN_MESSAGE,
            'fa' => 'خطای ناشناخته',
            'en' => 'Unknown Error',
            'retry' => false
        );
