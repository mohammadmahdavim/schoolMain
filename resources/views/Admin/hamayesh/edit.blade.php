        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="/admin/hamayesh/update/{{$row->id}}" enctype="multipart/form-data">
                        @csrf
                        @include('errors')
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label>زمینه</label>
                                <input type="text" class="form-control" id="context" value="{{$row->context}}"
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="editor-demo3">{!! $row->description !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="address" id="editor-demo2">{!! $row->address !!}</textarea>
                        </div>
                        <div class="form-group">
                            <label><h5>موارد مطرحی در همایش</h5></label>
                            <textarea name="items" id="editor-demo1">{!! $row->items !!}</textarea>
                        </div>
