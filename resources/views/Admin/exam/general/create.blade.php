...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <form action="/admin/exam/general/store" method="post" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class=" col-md-6" id="selectclass">
                        ...
                        <select id="dars" name="dars[]" multiple
                            ...
                            @foreach($darses as $dars)
                                <option style="text-align: right" value="{{$dars->id}}">
                        ...
                        <select id="class" name="class"
                            ...
                            @foreach($classes as $class)
                                <option style="text-align: right" value="{{$class->id}}">
