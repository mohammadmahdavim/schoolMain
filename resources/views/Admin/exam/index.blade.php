...
@section('header')
    <div class="page-header">
        <div>
            <h3>لیست آزمون های کلاس {{$id}} </h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/admin/home">داشبورد</a></li>
                    <li class="breadcrumb-item"><a href="#">آزمون آنلاین</a></li>
                    <li class="breadcrumb-item active" aria-current="page">لیست آزمون های کلاس {{$id}}</li>
                </ol>
            </nav>
        </div>
                ...
                <table class="table table-bordered table-striped mb-0 table-fixed" >
                    ...
                    <tbody>
                        ...
                        @foreach($exams as $exam)
                           ...
                           <td><a href="/admin/exam/student/{{$exam->examclass[0]->class->classnamber}}/{{$exam->id}}"><button class="btn btn-primary">کلیک کنید</button></a></td>
