        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">نمرات {{config('global.students')}}</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <div class="panel-body">
                    <h4><span class="btn btn-success">کلاس {{$idclass}}- درس {{$darss}}</span></h4>

                @if($itemcount==0)
                    <button class="btn btn-danger"><h6>  تا الان برای این کلاس    {{$itemcount}}  آیتم برای نمره دهی مشخص شده است ،
                            </h6>
                    </button>

                    @else
                        <h6> <button class="btn btn-success">  تا الان برای این کلاس    {{$itemcount}}  آیتم برای نمره دهی مشخص شده است ،
