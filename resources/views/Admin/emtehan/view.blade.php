        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#">مدیریت برنامه امتحانی</a></li>
                    ...
                    <table class="table">
                        ...
                        @foreach($barnamehs as $barnameh)
                            ...
                            <tr>
                                ...
                                <div class="media-body">
                                    <td><a href="{{ route('barname.download', $barnameh->id) }}"
                                           class="btn btn-outline-warning"> <i class="icon-download"></i> Download </a>

                                    </td>
                                    <td>
                                        <div>
                                            <button class="btn btn-danger" onclick="deleteData({{$barnameh->id}})">حذف
                                            </button>
                                        </div>
                                    </td>
                                </div>
