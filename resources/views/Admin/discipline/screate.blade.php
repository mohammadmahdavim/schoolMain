...
@section('content')
    <div class="card">
        <div class="card-body">
            <a href="/admin/discipline/index">
                <button class="btn btn-outline-danger">مشاهده موارد ثبت شده</button>
            </a>
            <form method="POST" action="/admin/discipline/store">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <select class="js-example-basic-single" id="student" name="student" dir="rtl">
                                    <option value="">نام دانش آموز را بنویسید</option>
                            ...
                            <div class="form-group col-md-4">
                                <br>
                                <label>تاریخ</label>
                                <input name="date" id="date-picker-shamsi" class="form-control" autocomplete="off">
                            </div>
                        </div>
