                ...
                <div class="panel-body">
                    ...
                    <div style="text-align: left;padding-left: 10px">
                        <a href="/admin/teacher">
                            <button class="btn btn-rounded btn-outline-dark">صفحه اطلاعات {{config('global.teachers')}}</button>
                        </a>
                    </div>
                    <form action="/admin/teacher.store" method="POST">
                        ...
                        <div class="col-md-6">
                            ...
                            <h6><label>کلاس  {{config('global.teacher')}}</label></h6>
                                <select name="class[]" class="js-example-basic-single" multiple style="text-align: right">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="dars"  class="form-control" style="text-align: right">
