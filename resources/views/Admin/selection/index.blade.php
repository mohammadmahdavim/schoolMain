        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{$rows->name}}</li>
                </ol>
            </nav>
        </div>
                ...
                <table id="example1" class="table  table-striped table-bordered ">
                    ...
                    @foreach($rows->selection as $row)
                        <tr class="form-group" style="text-align: center">
                            ...
                            <td style="text-align: center"><a href="/admin/selection/result/{{$row->id}}">
                                    <button class="btn btn-outline-dark">کلیک کنید</button>
                                </a></td>
                            <td style="text-align: center"><a href="/admin/selection/edit/{{$row->id}}">
