    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-1" style="text-align: left"><a href="/admin/Consultants/edit/{{$row->id}}">
                        <button class="btn btn-primary">ویرایش</button>
                    </a></div>
                <br>
                <br>
                <div class="col-md-1" style="text-align: left"><a href="/admin/Consultants/show/{{$row->place}}">
