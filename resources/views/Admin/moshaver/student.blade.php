                ...
                <table class="overflow-y" id="myTable">
                    ...
                    @foreach($users as $user )
                        <tr style="text-align: center">
                            ...
                            <td>{{$user->class}}</td>
                            <td>
                                @if(isset($user->rollcallmoshaver[0]) )

                                    <a href="/admin/moshaver/rollcall/absenttopresent/{{$user->rollcallmoshaver[0]->id}}">
                                        <span style="color:red">غایب</span>
                                    </a>
                                @else
                                    <a href="/admin/moshaver/rollcall/presenttoabsent/{{$user->id}}/{{$id}}">
                            ...
                            <td>
                             ...
                             <a href="/admin/moshaver/comment/{{$id}}/{{$user->id}}">
