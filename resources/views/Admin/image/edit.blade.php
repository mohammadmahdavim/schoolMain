    ...
    <div class="page-header">
        <div>
            <h3>
                ...
                ویرایش گالری تصاویر روی سایت
            </h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/admin/home">داشبورد</a></li>
                    <li class="breadcrumb-item">گالری تصاویر</li>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-1" style="text-align: left">
                            <a href="/admin/Image/singlepage/{{$row->id}}">
                                <button class="btn btn-dark">برگشت</button>
                            </a>
                        </div>
                    </div>
                    <br>
                    <form method="POST" action="/admin/Image/update/{{$row->id}}" enctype="multipart/form-data">
                        @csrf
                        @include('errors')
                        <div class="form-group">
                            <input class="form-control" id="place"
                                   name="place" value="گالری تصاویر">
                        </div>
                        <div class="form-group">
                            <label>عنوان</label>
