                ...
                <form  method="POST" action="/student/jtamrin.store{{$tamrin_id}}" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="center-text">
                            ...
                            <input class="form-control" type="number" id="class" name="class" readonly value="{{$class_id}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="center-text">
                    ...
                    <div class="col-md-12">
                        <div >
                            ...
                            <h6> <label> توضیحات من</label></h6>
                               <textarea id="editor-demo1" name="description" class="summernote" >{{old('description')}}</textarea>
