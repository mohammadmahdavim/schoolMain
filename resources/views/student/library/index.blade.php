    ...
    <div class="card">
        <div class="card-body">
            ...
            <div id='search' style="display: none">
                <form method="get" action="/student/library/school">
                    @csrf
                    ...
                    @foreach($data as $row)
                        <tr class="form-group" STYLE="text-align: center">
                            ...
                            <td class="text-center">
                                <a href="/student/library/reservation/">
                                    <form method="post" action="/student/library/reservation">
                                        @csrf
                                        <input name="library_id" value="{{$row->id}}" hidden>
                                        <input name="user_id" value="{{auth()->user()->id}}" hidden>
                                        <button type="submit" title="رزرو کردن" class="btn btn-warning btn-rounded">
                                            رزرو
                                        </button>
