        ...
        <div class="card-body">
            ...
            <div id="questions">
                @foreach($exams as $exam)
                    <button class="btn btn-primary">گزینه درست:{{$exam->myoptions[0]->correct}}</button>
                    <button class="btn btn-info">گزینه انتخابی شما:
                        @if(count($exam->useranswers)>0)
                            {{$exam->useranswers[0]->option_id}}
                        @endif
                    </button>
                    <div id="questions0">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <label>صورت سوال
                                    @if($exam->dars_id)
                                        -
                                        {{\App\dars::where('id',$exam->dars_id)->pluck('name')->first()}}&nbsp;
                                    @endif
                                </label>
                                <br>
