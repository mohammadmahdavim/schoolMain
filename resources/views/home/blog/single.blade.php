                            ...
                            <div class="col-xl-4 col-lg-5">
                                <div class="tm-portfoliodetails-info">
                                    <ul>
                                        ...
                                        <span style="color: #0d8d2d">{{\Morilog\Jalali\Jalalian::forge($row->updated_at)->format('%A, %d %B %y') }} </span>
                                        <div style="text-align: center">
                                            <a href="/blogs/create" class="btn btn-warning" style="text-align: center">
                                                <h4
                                                        style="text-align: center;color: black"><span
                                                            style="color: red"> کلیک کن </span> و
                            ...
                            <div class="col-xl-8 col-lg-7">
                                <div class="tm-portfoliodetails-description">
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="p-2">
                                            {{$row->like}}
                                            <a href="/blogs/like/{{$row->id}}" class="tm-readmore">
                                    ...
                                    <div class="tm-blog-comments mt-50">
                                        ...
                                        @if(\Illuminate\Support\Facades\Auth::check())
                                            ...
                                            @if (auth()->user()->level == 'admin')
                                                <h6 class="small-title" style="color: red">نظرات تایید نشده
                                                    ({{$nocount}})</h6>
                                            @endif
                                        @endif
