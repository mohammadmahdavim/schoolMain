...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <form action="/teacher/online/update/{{$row->id}}" method="PUT" enctype="multipart/form-data">
                ...
                <div class="row">
                        ...
                        <select id="rowteacher" name="class_id"
                            ...
                            @foreach($allclas->unique('class_id') as $allclass)
                                <option style="text-align: right"
                                        @if($allclass->class[0]->classnamber==$row->class_id) selected
                                        @endif value="{{$allclass->class[0]->classnamber}}">
                    ...
                    <div class="row col-md-12">
                        ...
                        <div class="col-md-3">
                            ...
                            <input style="text-align: center" name="member" type="number" class="form-control" value="{{$row->member}}"
                            >
                        </div>
                        <div class="col-md-3">
