...
@section('header')
    <div class="page-header">
        <div>
            <h3>آرشیو تمرین ها</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/teacher">داشبورد</a></li>
                    <li class="breadcrumb-item"><a href="#">تمرین</a></li>
                    <li class="breadcrumb-item active" aria-current="page">آرشیو تمرین ها</li>
                </ol>
            </nav>
        </div>
                    ...
                    @foreach($rows as $row )
                        <tr style="text-align: center">
                            ...
                            <td>
                                ...
                                <a href="/teacher/tamrin/sync/{{$row->id}}">
                                    <button class="btn btn-success">کلیک کنید</button>
                                </a></td>
                            <td>
                                <a href="/tamrin/count/{{$row->id}}" class="btn btn-outline-warning">

                                    <i
                                            class="icon-download"></i> Download </a></td>
                            <td><a href="/teacher/tamrin/show/{{$row->id}}">
